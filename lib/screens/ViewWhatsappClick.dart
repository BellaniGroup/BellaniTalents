...
class ViewWhatsappClick extends StatefulWidget {
  ViewWhatsappClick({Key? key}) : super(key: key);

  @override
  State<ViewWhatsappClick> createState() => _ViewWhatsappClickState();
}

class _ViewWhatsappClickState extends State<ViewWhatsappClick> {
