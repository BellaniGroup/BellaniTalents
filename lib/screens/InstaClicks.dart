...
class InstaClicks extends StatefulWidget {
  InstaClicks({Key? key}) : super(key: key);

  @override
  State<InstaClicks> createState() => _InstaClicksState();
}

class _InstaClicksState extends State<InstaClicks> {
