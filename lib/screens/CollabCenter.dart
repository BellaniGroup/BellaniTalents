...
class CollabCenter extends StatefulWidget {
  const CollabCenter({Key? key}) : super(key: key);

  @override
  State<CollabCenter> createState() => _CollabCenter();
}

class _CollabCenter extends State<CollabCenter> {
  ...
  void initState() {
    ...
    Marker resultMarker = Marker(
        onTap: () {
          Navigator.pushNamed(context, "/collabCenterDetails");
        },
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.pushNamed(context, "/postCollab");
                        },
                        child: Container(
                          height: 50,
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.pushNamed(context, "/manageCollabs");
                        },
                        child: Container(
                          height: 50,
                          width: double.infinity,
