...
class CompanyTalentsPackageRegister extends StatefulWidget {
  const CompanyTalentsPackageRegister({Key? key}) : super(key: key);

  @override
  State<CompanyTalentsPackageRegister> createState() =>
      _CompanyTalentsPackageRegisterState();
}

class _CompanyTalentsPackageRegisterState
    extends State<CompanyTalentsPackageRegister> {
