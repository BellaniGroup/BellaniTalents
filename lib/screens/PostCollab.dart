...
import 'package:bellani_talents_market/model/PostCollabDetails.dart';
...
class PostCollab extends StatefulWidget {
  const PostCollab({Key? key}) : super(key: key);

  @override
  State<PostCollab> createState() => _PostCollabState();
}

class _PostCollabState extends State<PostCollab> {
                    ...
                    GestureDetector(
                      onTap: () async {
                        if (_textController.text.isEmpty ||
                          ...
                          PostDealSuccess suc = await ApiService().postCollab(
                              PostCollabDetails(
                          ...
                          if (suc.status == "success") {
                            Navigator.pushNamed(context, "/collabRequirements",
                                arguments: {"collab_id": suc.id});
                          }
                        }
                      },
                      child: Container(
