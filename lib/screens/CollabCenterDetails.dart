...
class CollabCenterDetails extends StatefulWidget {
  const CollabCenterDetails({Key? key}) : super(key: key);

  @override
  State<CollabCenterDetails> createState() => _CollabCenterDetails();
}

class _CollabCenterDetails extends State<CollabCenterDetails> {
