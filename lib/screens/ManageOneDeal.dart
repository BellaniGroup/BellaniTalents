...
class ManageOneDeal extends StatefulWidget {
  const ManageOneDeal({Key? key}) : super(key: key);

  @override
  State<ManageOneDeal> createState() => _ManageOneDeal();
}

class _ManageOneDeal extends State<ManageOneDeal> {
