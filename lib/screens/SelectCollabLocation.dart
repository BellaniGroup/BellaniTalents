...
class SelectCollabLocation extends StatefulWidget {
  const SelectCollabLocation({Key? key}) : super(key: key);

  @override
  State<SelectCollabLocation> createState() => _SelectCollabLocation();
}

class _SelectCollabLocation extends State<SelectCollabLocation> {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Column(children: [
                            Text(
                              "Collab posted successfully!",
                              style: TextStyle(fontSize: 24),
                            ),
                            Text("Your new collab is now posted!",
                                style: TextStyle(fontSize: 18)),
                            GestureDetector(
                              onTap: () {
