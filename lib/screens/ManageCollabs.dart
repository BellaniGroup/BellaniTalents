...
class ManageCollabs extends StatefulWidget {
  ManageCollabs({Key? key}) : super(key: key);

  @override
  State<ManageCollabs> createState() => _ManageCollabsState();
}

class _ManageCollabsState extends State<ManageCollabs> {
